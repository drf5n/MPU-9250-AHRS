// original magneto code modified to accept .csv data input file
...
int main()
{
 ...
 //read file once to get length for arrays
 ...
 // print norm of input data
 xs /= nlines;
 printf("\r\nAverage length of %d input vectors = %lf\r\n",nlines,sqrt(xs));
...
// hm = 0.569;
 ...
 printf("\r\n float B {%8.2lf,%8.2lf,%8.2lf};\r\n",B[0],B[1],B[2]);
 printf("\r\n float Ainv {{%9.5lf,%9.5lf,%9.5lf},\r\n",A_1[0],A_1[1],A_1[2]);
 printf("             {%9.5lf,%9.5lf,%9.5lf},\r\n",A_1[3],A_1[4],A_1[5]);
 printf("             {%9.5lf,%9.5lf,%9.5lf}};\r\n",A_1[6],A_1[7],A_1[8]);
